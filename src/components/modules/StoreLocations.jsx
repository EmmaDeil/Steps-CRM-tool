  ...
  const getLocationStats = (locId) => {
    ...
    inventoryItems.forEach((item) => {
      ...
      if (stockLevel) {
        ...
        item.location === locations.find((l) => l._id === locId)?.name
      ) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {locations.map((loc) => {
              ...
              return (
                <div
                  key={loc._id}
                  className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors shadow-sm flex flex-col"
                >
                  ...
                  {loc.address && (
                    <p className="text-sm text-gray-500 mb-2 whitespace-pre-wrap">
                  ...
                  {loc.description && (
                    <p className="text-xs text-gray-400 mb-2">
                      <i className="fa-solid fa-circle-info mr-1 text-gray-300"></i>
                      {loc.description}
                    </p>
                  )}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <div className="w-full px-3 py-2 border border-gray-200 bg-gray-50 rounded text-sm font-mono text-gray-600 flex items-center justify-between">
                  ...
                  <span className="text-xs text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100 font-sans">
                    Auto-generated
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 text-white rounded text-sm font-medium flex gap-2"
                >
                  {isSubmitting ? (
