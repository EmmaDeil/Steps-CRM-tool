            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right font-semibold text-gray-600 rounded-tr-lg">
                    Amount
                  </th>
                </tr>
              </thead>
                ...
                {invoice.lineItems?.map((item, i) => (
                  <tr key={i}>
                    ...
                    <td className="px-4 py-3 text-center text-gray-600">
                      {item.qty || item.quantity} {item.quantityType || ""}
                    </td>
                    {!isAP && (
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between text-gray-600">
                ...
                <span className="font-medium">
                  {formatCurrency(
                    isAP ? invoice.totalAmount : invoice.subtotal,
                  )}
                </span>
              </div>
              ...
              <div className="pt-3 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-bold text-gray-900">
                    {formatCurrency(
                      isAP ? invoice.totalAmount : invoice.totalAmount,
                    )}
                  </span>
                </div>
              </div>
