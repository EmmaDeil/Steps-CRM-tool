...
const DocSignDashboard = () => {
  ...
  const handleReviewAndSign = (requestId) => {
    navigate(`/modules/docsign?id=${requestId}`);
  };
  ...
  return (
    <div className="w-full min-h-screen bg-[#f6f7f8] flex flex-col">
      ...
      {/* Page Header */}
      <header className="w-full bg-white border-b border-[#e5e7eb] p-2 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button className="flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-[#111418] border border-[#dbe0e6] px-5 py-2.5 rounded-lg font-semibold shadow-sm transition-all active:scale-95">
              <i className="fa-solid fa-plus-circle text-[18px]"></i>
              Create New Template
            </button>
            <button
              onClick={() => navigate("/modules/docsign-request")}
...
export default DocSignDashboard;
